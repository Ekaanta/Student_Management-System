...
RUN dotnet restore backend/AssignmentSystem.sln

# Copy all source files and publish
COPY backend/ ./backend/
RUN dotnet publish backend/AssignmentSystem.Api/AssignmentSystem.Api.csproj -c Release -o /app/publish /p:UseAppHost=false
