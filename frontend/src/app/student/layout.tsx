...
export default function StudentLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col md:flex-row text-slate-900 dark:text-slate-100 selection:bg-pink-500 selection:text-white transition-colors duration-300">
      {/* Mobile Top Header */}
      <header className="md:hidden sticky top-0 z-40 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <div className="w-9 h-9 rounded-md bg-gradient-to-tr from-pink-500 via-purple-500 to-indigo-500 flex items-center justify-center font-semibold text-white text-xs shrink-0">
            OP
          </div>
          <div>
            ...
            <span className="block text-[10px] font-semibold uppercase tracking-wider text-pink-600 dark:text-pink-400">
              Student Portal
            </span>
          </div>
        </div>
        ...
        <div className="md:hidden fixed inset-0 z-50 bg-slate-950/60 backdrop-blur-sm flex flex-col justify-between p-4 bg-white dark:bg-slate-900">
          <div>
            <div className="flex items-center justify-between pb-4 border-b border-slate-200 dark:border-slate-800 mb-4">
              <div className="flex items-center space-x-3">
                <div className="w-9 h-9 rounded-md bg-gradient-to-tr from-pink-500 via-purple-500 to-indigo-500 flex items-center justify-center font-semibold text-white text-xs">
                  OP
                </div>
                <div>
            ...
            <div className="pt-3 border-t border-slate-200 dark:border-slate-800/40 flex items-center justify-between">
              ...
              >
                {user.profilePictureUrl ? (
                  ...
                  <div className="w-9 h-9 rounded-xl bg-pink-500/20 text-pink-600 dark:text-pink-300 font-bold flex items-center justify-center shrink-0">
                    {user.firstName[0]}
                  </div>
                )}
      ...
      <aside className="hidden md:flex w-72 bg-white dark:bg-slate-900/90 border-r border-slate-200 dark:border-slate-800/80 flex-col justify-between p-6 shrink-0 sticky top-0 h-screen transition-colors duration-300">
        <div>
          <div className="flex items-center space-x-3 mb-8 shrink-0">
            <div className="w-10 h-10 rounded-md bg-gradient-to-tr from-pink-500 via-purple-500 to-indigo-500 flex items-center justify-center font-semibold text-white text-sm shrink-0">
              OP
            </div>
