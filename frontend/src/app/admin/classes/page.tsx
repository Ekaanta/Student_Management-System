  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">Class & Course Management</h1>
          <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Configure academic classes, unique class codes, and academic years.</p>
        </div>
        <button
              ...
              {classes.map((c) => (
                <tr key={c.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <span className="px-2.5 py-1 rounded-full text-xs font-bold bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300">
                      👥 {c.totalStudentsEnrolled} Students
                    </span>
                  </td>
